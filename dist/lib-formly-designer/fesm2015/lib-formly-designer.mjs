...
const generateUuid = () => {
    ...
    let d2 = ((performance === null || performance === void 0 ? void 0 : performance.now) && (performance.now() * 1000)) || 0;
...
class FieldsService {
    ...
    checkField(field, fields, parent) {
        ...
        return !this.traverseFields(fields, (f, p) => {
            ...
            if ((path === null || path === void 0 ? void 0 : path.length) !== length) {
                return;
            }
    ...
    find(id, fields) {
        ...
        while (stack.length) {
            ...
            if (((_a = field.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId']) === id) {
                return field;
            }
            if (field.fieldArray) {
    ...
    mutateField(field, editorField) {
        field.templateOptions = Object.assign({}, field.templateOptions);
    ...
    getFields(name, type) {
        var _a;
        const fields = (_a = this.getDesignerOptions(type)[name]) === null || _a === void 0 ? void 0 : _a.fields;
        if (!fields) {
            return [];
        }
...
class FormlyDesignerService {
    ...
    get selectedDesignerId() {
        var _a, _b;
        return (_b = (_a = this._selectedField.getValue()) === null || _a === void 0 ? void 0 : _a.templateOptions) === null || _b === void 0 ? void 0 : _b['$designerId'];
    }
    get designerFields() {
    ...
    createField(type) {
        ...
        if (designerType === null || designerType === void 0 ? void 0 : designerType.fieldArray) {
            field.fieldArray = { fieldGroup: [] };
        }
        if (type === 'formly-group' || (designerType === null || designerType === void 0 ? void 0 : designerType.fieldGroup)) {
            field.fieldGroup = [];
        }
        return field;
    }
    ...
    removeField(field) {
        ...
        const designerId = (_a = field.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId'];
    ...
    updateField(original, modified) {
        ...
        const designerId = (_a = original === null || original === void 0 ? void 0 : original.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId'];
    ...
    getWrappers(field) {
        ...
        const filterWrapper = (_a = this.designerConfig.settings.filterWrapper) !== null && _a !== void 0 ? _a : ((wrapper, _) => wrapper !== 'form-field');
    ...
    createPrunedField(field, fieldType = FieldType.Designer) {
        ...
        if (designerType) {
            ...
            if (fieldType === FieldType.Designer && ((_a = field.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId'])) {
    ...
    getDesignerType(field) {
        var _a, _b, _c;
        const type = (_c = (_b = (_a = field === null || field === void 0 ? void 0 : field.templateOptions) === null || _a === void 0 ? void 0 : _a['$fieldArray']) === null || _b === void 0 ? void 0 : _b.type) !== null && _c !== void 0 ? _c : field.type;
        const designerType = this.designerConfig.types[type];
        if (designerType) {
            return designerType;
        }
    ...
    replaceField(id, field, fields) {
        ...
        for (let i = 0, l = fields.length; i < l; i++) {
            ...
            if (((_a = otherField.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId']) === id) {
                if (field == null) {
                    fields.splice(i, 1);
                }
                else {
    ...
    replaceFieldArray(id, field, parent) {
        ...
        if (((_a = fieldArray.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId']) === id) {
            if (field) {
    ...
    path(control, includeSelf = true) {
        let path = '';
        let arrayNext = false;
        let root = includeSelf ? control : control === null || control === void 0 ? void 0 : control.parent;
        for (let child = root, parent = root === null || root === void 0 ? void 0 : root.parent; !!parent; child = parent, parent = parent.parent) {
    ...
    updateFields(fields, model) {
        var _a;
        this.designerFields = fields !== null && fields !== void 0 ? fields : cloneDeep(this.designerFields);
        // Update the selected field to use the updated instance, if any
        this._selectedField.next((_a = this.fieldsService.find(this.selectedDesignerId, this.designerFields)) !== null && _a !== void 0 ? _a : null);
        this.model = model !== null && model !== void 0 ? model : cloneDeep(this.model);
    }
}
...
class FormlyDesignerFieldWrapperComponent extends FieldWrapper {
    ...
    get parent() { var _a; return (_a = this.parentParentService) === null || _a === void 0 ? void 0 : _a.parent; }
    ...
    get designerId() { var _a; return (_a = this.field.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId']; }
    ...
    ngOnInit() {
        ...
        const content = (_b = this.content) === null || _b === void 0 ? void 0 : _b.nativeElement;
        if (!content) {
            return;
        }
    ...
    ngOnDestroy() {
        ...
        (_a = this.parentParentService) === null || _a === void 0 ? void 0 : _a.removeChild(this);
    }
    onClick(event) {
    ...
    onDragStart(event) {
        ...
        (_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.setData(DragDropType.Field, (_b = this.designerId) !== null && _b !== void 0 ? _b : '');
        this.dragDropService.beginDrag((_c = this.designerId) !== null && _c !== void 0 ? _c : null);
    }
    onDragEnd() {
    ...
    onDragOver(event) {
        ...
        this.zone.run(() => {
            ...
            this.dragDropService.dropTarget = (_b = (_a = this.field.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId']) !== null && _b !== void 0 ? _b : null;
        });
        event.preventDefault();
    }
    shouldHandleDragEvent(event) {
        var _a, _b;
        if ((_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.types.some(t => t === DragDropType.Field)) {
            return this.dragDropService.dragging !== this.designerId;
        }
        return !!((_b = event.dataTransfer) === null || _b === void 0 ? void 0 : _b.types.some(t => t === DragDropType.Type)) &&
            isString$1(this.dragDropService.dragging);
    }
    getDropTargetPlacement(event) {
        var _a;
        const rect = (_a = this.content) === null || _a === void 0 ? void 0 : _a.nativeElement.getBoundingClientRect();
        if (rect) {
    ...
    onDrop(event) {
        ...
        if (this.shouldHandleDragEvent(event)) {
            event.stopPropagation();
            if ((_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.types.includes(DragDropType.Field)) {
            ...
            else if ((_b = event.dataTransfer) === null || _b === void 0 ? void 0 : _b.types.includes(DragDropType.Type)) {
                if (this.dragDropService.dragging) {
                    if (this.parent && this.dropTargetPlacement !== DropPlacement.self) {
    ...
    addChildType(type, index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.addChildField(field, index);
        });
    }
    /**
    ...
    getDropPlacementIndex(dropField) {
        ...
        if (this.parent && this.dropTargetPlacement !== DropPlacement.self) {
            const parentChildren = dropField ?
                (_a = this.parentParentService) === null || _a === void 0 ? void 0 : _a.children.filter(fd => { var _a; return fd.designerId !== ((_a = dropField.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId']); }) :
                (_b = this.parentParentService) === null || _b === void 0 ? void 0 : _b.children;
            const dropIndex = (_c = parentChildren === null || parentChildren === void 0 ? void 0 : parentChildren.indexOf(this)) !== null && _c !== void 0 ? _c : 0;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: FormlyDesignerFieldWrapperComponent, decorators: [{
  ...
  `],
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: DragDropService }, { type: FieldsService }, { type: FormlyDesignerService }, { type: i0.NgZone }, { type: ParentService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
...
class DesignerExtension {
    postPopulate(field) {
        ...
        if ((_a = field === null || field === void 0 ? void 0 : field.templateOptions) === null || _a === void 0 ? void 0 : _a['$designerId']) {
...
class FieldEditorComponent {
    ...
    onTypeChange() {
        ...
        this.fieldArray = (designerType === null || designerType === void 0 ? void 0 : designerType.fieldArray) != null;
        this.fieldForm = this.fb.group({});
...
class FieldPickerComponent {
    ...
    get $modal() {
        var _a;
        return $((_a = this.modalRef) === null || _a === void 0 ? void 0 : _a.nativeElement);
    }
    add() {
        const type = this.type.value;
        const field = {};
...
class PropertiesComponent {
    ...
    ngOnInit() {
        this.subscriptions.push(this.formlyDesignerService.designerFields$.subscribe(fields => {
            var _a, _b, _c;
            const designerId = (_b = (_a = this.field) === null || _a === void 0 ? void 0 : _a.templateOptions) === null || _b === void 0 ? void 0 : _b['$designerId'];
            this.setField((_c = this.fieldsService.find(designerId, fields)) !== null && _c !== void 0 ? _c : null);
    ...
    setField(field) {
        ...
        if (field !== this.field) {
            this.field = field;
            this.fieldGroup = (field === null || field === void 0 ? void 0 : field.type) === 'formly-group' ||
                ((field === null || field === void 0 ? void 0 : field.type) && ((_a = this.formlyDesignerConfig.types[field.type]) === null || _a === void 0 ? void 0 : _a.fieldGroup)) != null;
...
class TypesComponent {
    ...
    onDragStart(event, type) {
        var _a;
        (_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.setData(DragDropType.Type, type);
...
class WrapperPickerComponent {
    ...
    get wrapper() {
        var _a;
        return (_a = this.form.get('wrapper')) === null || _a === void 0 ? void 0 : _a.value;
    }
    get $modal() {
        var _a;
        return $((_a = this.modalRef) === null || _a === void 0 ? void 0 : _a.nativeElement);
...
class WrappersPickerComponent {
    ...
    edit(index) {
        ...
        if (isObject(this.field)) {
            const field = cloneDeep(this.field);
            if (isArray(field === null || field === void 0 ? void 0 : field.wrappers)) {
                this.fieldEdit.setValue(field);
                const fields = this.formlyDesignerConfig.wrappers[this.wrapper].fields;
                if (isArray(fields) && fields.length > 0) {
                    this.$modal.modal('show');
    ...
    remove(index) {
        var _a, _b, _c;
        const fieldWrappersIndex = (_c = (_b = (_a = this.field) === null || _a === void 0 ? void 0 : _a.wrappers) === null || _b === void 0 ? void 0 : _b.indexOf(this.wrappers[index])) !== null && _c !== void 0 ? _c : -1;
...
//# sourceMappingURL=lib-formly-designer.mjs.map
